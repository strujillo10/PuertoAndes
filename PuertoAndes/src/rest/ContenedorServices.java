...
@Path("contenedores")
public class ContenedorServices 
{
	// Servicios REST tipo GET:
		...
		public Response getContenedores() {
			PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
			ListaContenedor contenedores;
			try {
				contenedores = tm.darContenedores();
			} catch (Exception e) {
				return Response.status(500).entity(doErrorMessage(e)).build();
			}
			return Response.status(200).entity(contenedores).build();
		}
		...
		@Path("/id/{id}")
		@Produces({ MediaType.APPLICATION_JSON })
		public Response getContenedorId(@javax.ws.rs.PathParam("id") int id) {
			PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
			ListaContenedor contenedores;
			try {
				if (id == 0)
					throw new Exception("Id del video no valido");
				contenedores = tm.buscarContenedorPorId(id);
			} catch (Exception e) {
				return Response.status(500).entity(doErrorMessage(e)).build();
			}
			return Response.status(200).entity(contenedores).build();
		...
		@Produces(MediaType.APPLICATION_JSON)
		public Response addContenedor(Contenedor contenedor) {
			PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
			try {
				tm.addContenedor(contenedor);
			} catch (Exception e) {
				return Response.status(500).entity(doErrorMessage(e)).build();
			}
			return Response.status(200).entity(contenedor).build();
		}
		...
		@Consumes(MediaType.APPLICATION_JSON)
		@Produces(MediaType.APPLICATION_JSON)
		public Response addContenedores(ListaContenedor contenedores) {
			PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
			try {
				tm.addContenedores(contenedores);
			} catch (Exception e) {
				return Response.status(500).entity(doErrorMessage(e)).build();
			}
			return Response.status(200).entity(contenedores).build();
		...
		@Consumes(MediaType.APPLICATION_JSON)
		@Produces(MediaType.APPLICATION_JSON)
		public Response updateContenedor(Contenedor contenedor) {
			PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
			try {
				tm.updateContenedor(contenedor);
			} catch (Exception e) {
				return Response.status(500).entity(doErrorMessage(e)).build();
			}
			return Response.status(200).entity(contenedor).build();
		...
		@Consumes(MediaType.APPLICATION_JSON)
		@Produces(MediaType.APPLICATION_JSON)
		public Response deleteContenedor(Contenedor contenedor) {
			PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
			try {
				tm.deleteContenedor(contenedor);
			} catch (Exception e) {
				return Response.status(500).entity(doErrorMessage(e)).build();
			}
			return Response.status(200).entity(contenedor).build();
