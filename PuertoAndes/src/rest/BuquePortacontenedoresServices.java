...
@Path("buquesP")
public class BuquePortacontenedoresServices 
{
	...
	public Response getBuquesP() {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		ListaBuquePortacontenedores buquesP;
		try {
			buquesP = tm.darBuquesP();
		} catch (Exception e) {
	...
	@Path("/id/{id}")
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getBuquePId(@javax.ws.rs.PathParam("id") int id) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		ListaBuquePortacontenedores buquesP;
		try {
			if (id == 0)
				throw new Exception("Id del video no valido");
			buquesP = tm.buscarBuquePPorId(id);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(buquesP).build();
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response addBuqueP(BuquePortaContenedores buqueP) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.addBuqueP(buqueP);
		} catch (Exception e) {
		...
		return Response.status(200).entity(buqueP).build();
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateBuqueP(BuquePortaContenedores buqueP) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.updateBuqueP(buqueP);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(buqueP).build();
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response deleteBuqueP(BuquePortaContenedores buqueP) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.deleteBuqueP(buqueP);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(buqueP).build();
