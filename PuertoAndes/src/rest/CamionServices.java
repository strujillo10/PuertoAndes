...
public class CamionServices 
{
	...
	public Response getCamiones() {
		...
		try {
			camiones = tm.darCamiones();
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(camiones).build();
	}
	...
	@Path("/id/{id}")
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getCamionId(@javax.ws.rs.PathParam("id") int id) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		ListaCamion camiones;
		try {
			if (id == 0)
				throw new Exception("Id del video no valido");
			camiones = tm.buscarCamionPorId(id);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(camiones).build();
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response addCamion(Camion camion) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.addCamion(camion);
		} catch (Exception e) {
		...
		return Response.status(200).entity(camion).build();
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response addCamiones(ListaCamion camiones) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.addCamiones(camiones);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(camiones).build();
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateCamion(Camion camion) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.updateCamion(camion);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(camion).build();
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response deleteCamion(Camion camion) {
		PuertoAndesMaster tm = new PuertoAndesMaster(getPath());
		try {
			tm.deleteCamion(camion);
		} catch (Exception e) {
			return Response.status(500).entity(doErrorMessage(e)).build();
		}
		return Response.status(200).entity(camion).build();
