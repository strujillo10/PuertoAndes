...
public class DAOContenedor 
{
	 ...
	 */
	public ArrayList<Contenedor> darContenedores() throws SQLException, Exception 
	{
		...
		while (rs.next()) {
			...
			contenedores.add(new Contenedor(id, tipo, peso));
		}
		return contenedores;
	}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public ArrayList<Contenedor> buscarContenedorPorId(int id) throws SQLException, Exception 
	{
		ArrayList<Contenedor> contenedores = new ArrayList<Contenedor>();

		String sql = "SELECT * FROM CONTENEDOR WHERE ID ='" + id + "'";
		...
		while (rs.next()) {
			...
			String tipo = rs.getString("TIPO");
			int peso = Integer.parseInt(rs.getString("PESO"));
			contenedores.add(new Contenedor(id2, tipo, peso));
		}
		return contenedores;
	}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void addContenedor(Contenedor contenedor) throws SQLException, Exception 
	{
		String sql = "INSERT INTO CONTENEDOR VALUES (";
		sql += contenedor.getId() + ",'";
		sql += contenedor.getTipo() + ",'";
		sql += contenedor.getPeso() + ")";
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void updateContenedor(Contenedor contenedor) throws SQLException, Exception 
	{
		String sql = "UPDATE CONTENEDOR SET ";
		sql += "tipo='" + contenedor.getTipo() + "',";
		sql += "peso='" + contenedor.getPeso() + "',";
		sql += " WHERE id = " + contenedor.getId();
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void deleteContenedor(Contenedor contenedor) throws SQLException, Exception 
	{

		String sql = "DELETE FROM CONTENEDOR";
		sql += " WHERE id = " + contenedor.getId();
